...
URL_MAJSOUL: Final[str] = "https://mahjongsoul.game.yo-star.com/"
	...
	def __init__(
		...
		*,
		...
		if user_data_dir:
			...
			self._context = self._context_manager.start().firefox.launch_persistent_context(  # noqa: E501
				user_data_dir,
				args=options,
			...
			self._browser = self._context_manager.start().firefox.launch(
				args=options,
				ignore_default_args=mute_audio_off,
				headless=headless,
			)
